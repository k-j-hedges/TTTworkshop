...
header-includes: \usepackage{mathptmx}
output:
...
knitr::opts_chunk$set(
  ...
  autodep = TRUE,
  cache = TRUE,
  # If a chunk needs to be updated each time (i.e. it depends on input that is outside the scope of this file and changes in that outside file would not be detected), set cache = FALSE in the chunk header
...
# Added , echo-FALSE above to hide code
fit <- lm(y ~ x)
print(summary(fit))
``` 
